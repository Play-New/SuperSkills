...
export interface ToolsCatalog {
  ...
  eiidMapping: {
    enrichment: { description: string; tools: string[] };
    inference: { description: string; tools: string[] };
    interpretation: { description: string; tools: string[] };
    delivery: { description: string; tools: string[] };
  };
}
