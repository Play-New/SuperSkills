...
export function createStrategyPrompt(discovery: DiscoveryResult): string {
...
export function createDesignPrompt(discovery: DiscoveryResult): string {
  return `# Design Skill
...
export function createTrustPrompt(discovery: DiscoveryResult): string {
...
export function createEfficiencyPrompt(discovery: DiscoveryResult, tools?: SelectionResult): string {
...
export function createTestingPrompt(discovery: DiscoveryResult): string {
